...
export default function Home() {
	...
	return (
		<div className='min-h-screen p-5 sm:p-10 md:p-20' style={{ backgroundColor: COLORS.mainLayoutBackground }}>
			<h1 className='text-white text-center text-4xl font-semibold py-5'>DASHBOARD</h1>
